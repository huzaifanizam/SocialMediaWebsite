        ...
        <div class="container">
            ...
            <div class="create">
                ...
                <div class="profile-photo">
                    <img src="./images/HUZAIFA.JPG" alt="">
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="middle">
                ...
                <form action="" class="create-post">
                    ...
                    <button class="btn btn-primary" id="openDialog">Post</button>
                    <!-- <input type="submit" value="Post" class="btn btn-primary"> -->
                </form>
                <dialog id="myDialog">
                    <form action="post.php" method="post" enctype="multipart/form-data">
                        <div class="search-bar">
                            <input name="title" type="search" placeholder="Title of Your Post">
                        </div>
                        <br>
                        <div class="search-bar">
                            <input name="description" type="search" placeholder="Description of Your Post">
                        </div>
                        <br>
                        <div class="search-bar">
...
$sql = "SELECT title, description, file, created_at FROM post ORDER BY created_at DESC";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        <div class="feed">
            <div class="head">
                <div class="user">
                    ...
                    <div class="info">
                        ...
                        <small>' . htmlspecialchars($created_at) . '</small>
                    </div>
                </div>
                <span class="edit">
            ...
            <div class="caption">
                <p><b>' . htmlspecialchars($title) . '</b> ' . htmlspecialchars($description) . '
